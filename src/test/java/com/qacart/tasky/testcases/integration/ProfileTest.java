...
public class ProfileTest extends BaseTest {
    ...
    @Test(description = "Free User Should be Able to See `Regular User` Inside Profile Page")
    ...
    @Test(description = "Advanced User Should be Able to See `Advanced User` Inside Profile Page")
    ...
    @Test(description = "User Should be Able to Change Password")
    ...
    @Test(description = "User Should not be Able to Change Password with Incorrect Current Password")
